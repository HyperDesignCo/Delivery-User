package com.example.delivaryUser.feature.authentication.login.ui.view
...
private fun LoginContent(state: LoginContract.State, action: (LoginContract.Action) -> Unit) {
    Column(
        ...
        RegisterNewAccount(modifier = Modifier.padding(top = 8.dp))
...
@Composable
private fun RegisterNewAccount(modifier: Modifier = Modifier) {
    Row(
        modifier = modifier.fillMaxWidth(),
