...
import com.hyperdesign.delivaryUser.common.data.repository.local.LocalDataSourceProvider
import com.hyperdesign.delivaryUser.common.data.repository.remote.ApiService
import com.hyperdesign.delivaryUser.common.data.repository.remote.RemoteDataSourceProvider
import com.hyperdesign.delivaryUser.common.data.repository.remote.provideHttpClient
...
import com.hyperdesign.delivaryUser.common.ui.eventcontroller.EventController
...
import com.hyperdesign.delivaryUser.common.ui.navigation.Navigator
...
val appModule = module {
    ...
    single<ApiService> { ApiService(provideHttpClient(get(), get(), get())) }
