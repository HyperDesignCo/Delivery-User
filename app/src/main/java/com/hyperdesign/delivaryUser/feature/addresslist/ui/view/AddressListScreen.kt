package com.hyperdesign.delivaryUser.feature.addresslist.ui.view
...
import com.hyperdesign.delivaryUser.feature.addresslist.ui.viewmodel.AddressListContract
        ...
        state = AddressListContract.State(
            addressList = listOf(
                AddressListContract.AddressUiState(
                    address = Address(
                        id = 1,
                        firstPhone = "+201234567890",
                        secondPhone = "+201098765432",
                ...
                AddressListContract.AddressUiState(
                    address =
                        Address(
                            id = 3,
                            firstPhone = "+201555666777",
                            secondPhone = "+201444333222",
